...
//        * Идентификаторы      - Структура - Идентификаторы адресных объекта, если установлен параметр КодыКЛАДР.
//           ** Регион          - Строка    - Идентификатор региона.
//           ** Район           - Строка    - Идентификатор район.
//           ** Город           - Строка    - Идентификатор города.
//           ** НаселенныйПункт - Строка    - Идентификатор населенного пункта.
//           ** Улица           - Строка    - Идентификатор улица.
//         * ИдентификаторАдресногоОбъекта  - Строка - Идентификатор адресного объекта наименьшего уровня в иерархи адреса(без учета домов), если установлен параметр КодыКЛАДР.
//                                            (Например, улицы для Адреса: Московская обл, Коломенский р-н, Печная д, Озерная ул, дом № 7).
...
Функция АдресПоИдентификатору(ИдентификаторАдреса, ДополнительнаяИнформацияАдреса = Неопределено) Экспорт
	...
	Иначе
		Адрес.Страна = Строка(ОсновнаяСтрана());
	КонецЕсли;
	...
	РасчетноеПредставление = УправлениеКонтактнойИнформациейСлужебный.ПредставлениеАдреса(Адрес, ВидИнформации);
