...
Процедура ОтключитьСинхронизациюДанных(Команда)
	...
	Если ТекущиеДанные <> Неопределено
		...
		ИначеЕсли ТекущиеДанные.ЭтоОбменСЛокальнойВерсией
			Или ТекущиеДанные.СинхронизацияОтключенаВМенеджереСервиса Тогда
...
Процедура НастройкиСинхронизацииДанныхПриАктивизацииСтроки(Элемент)
	...
	Если Не ТекущиеДанные = Неопределено Тогда
		...
		ДоступноОтключение     = ТекущиеДанные.СинхронизацияНастроена
			И Не ТекущиеДанные.НастройкаСинхронизацииВМенеджереСервиса;
...
Процедура ПрочитатьНастройкиСинхронизацииДанных(Отказ)
	...
	Попытка
		...
		Для Каждого НастройкаИзМенеджераСервиса Из НастройкиСинхронизацииИзМенеджераСервиса Цикл
			...
			Если Не ЗначениеЗаполнено(УзелКорреспондент) Тогда
				КодЭтогоУзла = ОбменДаннымиСервер.КодПредопределенногоУзлаПланаОбмена(Настройка.ПланОбмена);
			...
			Если ЗначениеЗаполнено(УзелКорреспондент) Тогда
				...
				Иначе
					Настройка.Описание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Синхронизация данных между программами была отключена в ""%1"".
						|Для возобновления синхронизации данных необходимо
						|  - выполнить команду ""Еще -> Отключить"";
						|  - выполнить настройку синхронизации повторно.'"),
